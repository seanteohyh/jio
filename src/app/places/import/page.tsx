          ...
          {visible.length === 0 ? (
            ...
            <ul className="space-y-2">
              {visible.map((candidate) => (
                <li
                  key={candidate}
                  className="border-dolch-border bg-dolch-surface/60 flex items-center justify-between gap-3 rounded-xl border p-3"
                >
                  ...
                  <span className="flex shrink-0 gap-2">
                    ...
                    <button
                      ...
                      className="text-dolch-muted text-xs underline"
                    >
                      Not a place
                    </button>
                  </span>
